...
//        flag = false;
//       if( $(this).text().toLowerCase() == 'регистрация' ) {
//         $('#input-password-info').text('Введите пароль (минимум 6 символов)!').css({'transition':'height .5s','height':'30px'});
//       } else {
//         $('#input-password-info').text('Enter the password (minimum 6 characters)!').css({'transition':'height .5s','height':'30px'});
//       }
//     }
...
//       } else {
//         $('#input-password-info').text('Passwords do not match!').css({'transition':'height .5s','height':'30px'});
//       }
//     }
...
//       CustomerPhone: $('#input-country-code').val()+$('#input-company-code').val()+$('#input-phone').val(),
//       CustomerCountry: $('#select-country option:selected').text(),
...
//       }
//       $.ajax({
//             url: "https://crm.investingcase.com/api/LidsSelfRegisr",
//             type: "POST",
//             data: dat,
//             success: function (data) {

//         if(data=="Ok"){
//           location.href = 'https://platform.investingcase.com/Home/LoginSite?email='+dat.CustomerEmail+'&pass='+dat.CustomerPassword
//         }else{
//           alert("Пользователь с таким E-mail уже зарегистрирован в системе.        The user with this E-mail is already registered in the system.");
//         }
//             }
//         });
// }
...
//     }
//   });
//   $('#input-confirm-pass').keyup(function(){
...
//   $('#input-country-code, #input-company-code, #input-phone').keyup(function(){
