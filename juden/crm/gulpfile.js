...
gulp.task('watch', gulp.parallel(
  gulp.series('sass', 'sass-bem', 'js-libs', 'js', 'js-bem', 'pug', 'browser-sync'),
  function() {
    gulp.watch(['app/scss/*.+(scss|sass)'], gulp.series('sass'));
    gulp.watch(['app/BEM-blocks/*/*.+(scss|sass)'], gulp.series('sass-bem','sass'));

    // gulp.watch(['app/libs-js/*.js'], gulp.series('js-libs','pug'));
